...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("Noahs-aRk"),
	impl_name: create_runtime_str!("Noahs-aRk"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 1,
...
parameter_types! {
	pub const IndexDeposit: Balance = 10;
}
...
parameter_types! {
	pub const Prefix: &'static [u8] = b"Pay aRk tokens to account:";
}

impl air_drop::Trait for Runtime {
	type Event = Event;
